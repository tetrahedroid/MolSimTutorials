...
> **Table 1.1** 我々のグループが所有する計算機 (2022 年 7 月)。stella[01]というのは、stella0 と stella1 という名前の計算機があるという意味。他の計算機についても同様。故障などにより抜けていることもある。文字が灰色のマシンは休止中だが、起動させれば利用可能。IP アドレスは空欄にしてある。リブートするごとに変わる可能性があるので、[LoadMeters](http://172.23.78.218:8080)で調べる。
